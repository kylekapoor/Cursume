      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          <div className="pb-12 text-center md:pb-20">
            <h1
              className="mb-4 font-nacelle text-5xl font-bold text-white md:text-6xl"
              data-aos="fade-up"
            >
              Cursume
            </h1>
            ...
            <h2
              className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-2xl font-semibold text-transparent md:text-3xl"
              data-aos="fade-up"
              data-aos-delay={100}
            >
            ...
            <div className="mx-auto max-w-3xl">
              <p
                className="mb-8 text-med text-indigo-200/65"
                data-aos="fade-up"
                data-aos-delay={200}
              >
                  ...
                  <SignInButton mode="redirect" forceRedirectUrl="/tools">
                    ...
                    >
                      <span className="relative inline-flex items-center">
                        Get Started
                        <span className="ml-1 text-white/50 group-hover:translate-x-1 transition-transform duration-200">
                          -&gt;
                        </span>
                      </span>
                    </a>
